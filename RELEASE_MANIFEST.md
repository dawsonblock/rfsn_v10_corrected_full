...
| Git commit | `791adfe2caedeceaeadc25897e2f2bec78f3c00d` |
...
| `pytest tests/test_clickhouse_security.py` | PASS (29 tests) |
...
Total gate tests: **157 passed, 0 failed**
...
4. **No production HTTP server**: Docker runs CLI healthcheck only
...
- [x] Full non-MLX test gate — PASS (134 tests)
- [x] Full MLX gate — PASS (23 tests)
...
- [ ] README updated with known-failures section
