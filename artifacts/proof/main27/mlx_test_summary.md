...
pytest tests/test_fused_kernel_mlx.py \
       ...
       -vv -s --tb=short \
       | tee artifacts/proof/main27/mlx_pytest_raw.log
...
pytest tests/test_fused_kernel_mlx.py \
       ...
       tests/test_retrieve_blocks.py \
       tests/test_sparse_safety_gate.py \
       --junitxml artifacts/proof/main27/mlx_pytest_junit.xml
```
...
## Artifacts
- Raw log: `artifacts/proof/main27/mlx_pytest_raw.log`
- JUnit XML: `artifacts/proof/main27/mlx_pytest_junit.xml`

## Notes
Main 27 — Validation Semantics Correction + Full Rebrand. All MLX-dependent tests must pass without Metal fallback.
